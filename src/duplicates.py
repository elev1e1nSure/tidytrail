...
def prompt_deletion(groups: dict[str, list[FileInfo]]) -> int:
    ...
    for hash_val, file_list in groups.items():
        ...
        console.print(f"\n  [n]ewer - keep newest, delete others")
        console.print(f"  [o]lder - keep oldest, delete others")
        console.print(f"  [a]ll - keep first, delete others")
        console.print(f"  [s]kip - keep all")
